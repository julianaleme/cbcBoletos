...
var Datas = (function () {
	...
	function FormDatas(cDataAjust) {
		var cDataFormat = cDataAjust.substr(8,2) + '/' + cDataAjust.substr(5,2) + '/' + cDataAjust.substr(0,4)
		return cDataFormat
	}
	function Datas() {
...
var Boleto = (function () {
	...
	Boleto.prototype.getValorDescontosFormatadoBRL = function () {
		...
		return formatarBRL(this.getValorDescontos());
	}
	...
	Boleto.prototype.getValorDeducoesFormatadoBRL = function () {
		...
		return formatarBRL(this.getValorDeducoes());
	}
	...
	Boleto.prototype.getValorMultaFormatadoBRL = function () {
		return formatarBRL(this.getValorMulta());
	}
	...
	Boleto.prototype.getValorAcrescimosFormatadoBRL = function () {
		return formatarBRL(this.getValorAcrescimos());
	}
